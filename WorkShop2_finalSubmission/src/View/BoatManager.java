...
public class BoatManager extends MainManu{
	...
	public void boatManager() throws Exception {
		...
		selector = new SelectAMemberOrBoat(path);
		try {
		...
		if(command == 2){
			System.out.println("Select the boat you want to delete...");
		
			super.singleBoat = selector.listAndSelectMembers_Boats(singleMember);
			
			super.dataUpdater.deletBoat(super.singleBoat);
			super.mainListPrintOut();
	...
	public boolean updateBoat() {
		System.out.println("Select the boat you want to update...");
		...
		scan = new Scanner(System.in);
		System.out.print("Updateing a boat.\n New boat name --> ");
		String boatName= scan.nextLine();
		System.out.print("\n New boat Type --> ");
		String boatType= scan.nextLine();
		System.out.print("\n New boat Length --> ");
		...
		try {
			super.dataUpdater.updateBoat(singleBoat, boatName, boatType, boatLength);
